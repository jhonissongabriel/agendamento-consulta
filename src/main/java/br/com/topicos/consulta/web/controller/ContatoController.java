...
import br.com.topicos.consulta.service.ContatoService;
...
public class ContatoController {
	...
	public ResponseEntity<Contato> pesquisarPorId(@RequestParam(value = "id") Long id) {
	...
	@RequestMapping(value = "/getSite", method = RequestMethod.GET, produces = { "application/json",
			"application/xml" })
	@JsonView(View.Basico.class)
	public ResponseEntity<Collection<Contato>> pesquisarPorSite(@RequestParam(value = "site") String site) {
		return new ResponseEntity<Collection<Contato>>(contatoService.buscarSite(site), HttpStatus.OK);
	}
